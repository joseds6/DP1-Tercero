...
<acme:form readonly="false">
	...
	<acme:form-textarea code="anonymous.bulletin.form.label.sport" path = "sport"/>
	<acme:form-submit code="anonymous.bulletin.form.button.create" action="/anonymous/garcia-bulletin/create"/>
