...
<acme:form readonly="false">
	...
	<acme:form-textarea code="anonymous.bulletin.form.label.song" path = "song"/>
	<acme:form-submit code="anonymous.bulletin.form.button.create" action="/anonymous/soto-bulletin/create"/>
